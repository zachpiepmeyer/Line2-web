			...
			case('Left') : ?>        
				...
				?>" <?php echo ($ag_section['backgroundstyle']) ? $ag_section['backgroundstyle'] : '' ?>>
                    ...
                    <?php if ( is_user_logged_in() ) { ?>
                    	<!-- Edit Post Button -->
                        <a href="<?php echo get_edit_post_link( $section ); ?>" class="post-edit-link"><img src="<?php echo get_template_directory_uri(); ?>/images/edit-pencil.png" alt="<?php _e('Edit Section', 'framework'); ?>"/><?php _e('Edit', 'framework'); ?></a>
                    <?php } ?> 
                </div>
				...
				?>" <?php echo ($ag_section['backgroundstyle']) ? $ag_section['backgroundstyle'] : '' ?>>
                    <div class="container">
                        ...
                        <div class="fourteen columns offset-by-one fullimage">
                            ...
                            // Get Featured Slideshow or Section Video
                            if (!$ag_section['sectionvideo'] || $ag_section['sectionvideo'] == '') {
                                echo ag_post_slideshow('sectionlarge', $section, $ag_post['slide_number'], true);
                            } else {
                                echo ag_post_video($ag_section['sectionvideo']);	
                            }?>
                        </div>
